...
<form action="UserViewComplaintAfterSearching.php" method="post">
...
<br><p style="text-align: center;font-family:Courier New;font-size:150%;"><b>~~ MY COMPLAINT LIST ~~</b></p>
    ...
    echo "<table>";
        ...
        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)){
                ...
                $length = 5;
                $string = substr(str_repeat(0, $length).$complaintID,-$length);
