...
switch ($action) {
    ...
    case 'rDetails':
        ...
        if (isset( $_FILES['rdPhoto']['name'] ) && $_FILES['rdPhoto']['name'] != '' ) {
            $loc="../resources/restaurant/$RO_username/$oldPhoto";
            if (is_file($loc)) {
                unlink(realpath($loc));
            }
            $imageName=$id . str_replace(" ", "-", strtolower("$rdName")). ".png";
            $sourcePath=$_FILES['rdPhoto']['tmp_name'];
            $targetPath="../resources/restaurant/$RO_username/".$imageName;
    ...
    case 'rDetailsAdd':
        ...
        if (isset($_FILES['rdPhoto']['name']) && $_FILES['rdPhoto']['name'] != '') {
            $imageName=++$rowcount . "-" . str_replace(" ", "-", strtolower("$rdName")). ".png";
            $sourcePath=$_FILES['rdPhoto']['tmp_name'];
            $targetPath="../resources/restaurant/$RO_username/".$imageName;
            $upload=move_uploaded_file($sourcePath,$targetPath);
