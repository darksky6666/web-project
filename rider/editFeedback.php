...
<header class="wrapper">
        ...
        <img src="../resoures/foody logo.png" alt="Foody" width="100" height="100">
        <nav>
...
$query = "SELECT o.order_ID, c.complaint_ID, c.complaintDate, c.complaintTime, c.complaintStatus, c.complaintType, c.complaintDesc, u.name, f.fDesc 
FROM complaint_list AS c, user AS u, order_list AS o, feedback AS f 
WHERE c.order_ID = o.order_ID AND o.username = u.username AND f.order_ID = o.order_ID 
...
?>
    ...
    <div>
        ...
        <form action="updateFeedbackDB.php?id=<?php echo $id; ?>" method="post">
            <br><br>&nbsp;&nbsp;&nbsp;Feedback:<br/>
            <textarea name = "fDesc" rows = "5" style="width:100%"><?php echo $fDesc ?></textarea>
         </div>
    </div>
