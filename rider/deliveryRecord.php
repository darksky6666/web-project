...
<br>
  ...
  <body>
    ...
    <h2 align="center">Delivery Record</h2>
    <h3 align="center">Completed Delivery List</h3>

<?php
include("../db/db.php");

$query = "SELECT o.order_ID, o.orderDate, o.orderTime, o.orderStatus, u.name FROM order_list AS o, user AS u WHERE o.username = u.username AND o.orderStatus = 'Completed';";
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      $string = substr(str_repeat(0, $length).$id,-$length);
        ...
        echo "<tr><td>". 
                ...
                "<a href='setTimeDelivered.php?id=$id'>" .
                '<button style="margin-left:10%; "type="submit" name="view">View Record Details</button>' .
                '</a>' .
                "</td></tr>";
            }
        }
