...
FROM complaint_list AS c, user AS u, order_list AS o, feedback AS f WHERE f.order_ID = o.order_ID AND c.order_ID = o.order_ID AND o.username = u.username 
    ...
    <div class="row">
        ...
        <div class="column2">
            <table style="width:100%">
                <tr>
                <td style="border:1px solid grey">Complaint Status:<br><b class="resolved"><?php echo $complaintStatus; ?></b></td>
                </tr>
            </table>
            <br>
    ...
    <div>
        <div class="margin">
            ...
            <table>
                ...
                <tr>
                    <td colspan="3" style="border: 1px solid #ddd"><?php echo $fDesc; ?><br><br></td>
                </tr>
            </table>
         </div>
    </div>
        ...
        <form action="deliveryRecord.php?id=<?php echo $id; ?>" method="post">
            <br><br><br><input type="submit" class="button" style="width:200px" name="backToViewComplaint" value="Back to Delivery Record List">
        </form>
</body>
